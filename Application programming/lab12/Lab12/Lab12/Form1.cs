...
namespace Lab12
{
    ...
    public partial class Form1 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            {
                OrgInfo q = new OrgInfo(Encoding.GetEncoding(866).GetBytes(textBox1.Text),
                    Encoding.GetEncoding(866).GetBytes(textBox2.Text), Convert.ToInt32(textBox3.Text),
                    Encoding.GetEncoding(866).GetBytes(textBox4.Text));
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            if (textBox1.Text == "")
            {
                MessageBox.Show("Enter the name of an organization");
            }
            else
            {
                try
                    ...
                    while (fs1.Position < fs1.Length)
                    {
                        ...
                        if (textBox1.Text != "")
                            if (textBox1.Text.ToLower() !=
                                Encoding.GetEncoding(866).GetString(org3.name).Trim('\0').ToLower())
                            {
                                t = false;
                            }
                        ...
                        if (textBox2.Text != "")
                            if (textBox2.Text.ToLower() !=
                                Encoding.GetEncoding(866).GetString(org3.address).Trim('\0').ToLower())
                            {
                                t = false;
                            }
                        ...
                        if (textBox4.Text != "")
                            if (textBox4.Text.ToLower() !=
                                Encoding.GetEncoding(866).GetString(org3.contact).Trim('\0').ToLower())
                            {
                                t = false;
                            }
        ...
        private void button5_Click(object sender, EventArgs e)
        {
            if (button3.Text == "Complete")
            {
                OrgInfo q2 = new OrgInfo(Encoding.GetEncoding(866).GetBytes(textBox1.Text),
                    Encoding.GetEncoding(866).GetBytes(textBox2.Text), Convert.ToInt32(textBox3.Text),
                    Encoding.GetEncoding(866).GetBytes(textBox4.Text));
                try
                {
