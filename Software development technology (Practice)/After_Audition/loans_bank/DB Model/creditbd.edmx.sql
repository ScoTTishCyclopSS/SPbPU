...
-- --------------------------------------------------
-- Date Created: 11/28/2018 12:05:08
-- Generated from EDMX file: C:\Users\Fedmedio\Desktop\STUDY_PC\ТРПО\interYOURMOMface\interYOURMOMface\creditbd.edmx
-- --------------------------------------------------
...
IF OBJECT_ID(N'[dbo].[FK_creditcard]', 'F') IS NOT NULL
ALTER TABLE [dbo].[credit] DROP CONSTRAINT [FK_creditcard];
GO
IF OBJECT_ID(N'[dbo].[FK_creditcustomer]', 'F') IS NOT NULL
ALTER TABLE [dbo].[credit] DROP CONSTRAINT [FK_creditcustomer];
GO
...
(
    ...
    [bill_number] nvarchar
(
    max
) NOT NULL,
    [check_number] nvarchar
(
    max
) NOT NULL,
    [cvv] nvarchar
