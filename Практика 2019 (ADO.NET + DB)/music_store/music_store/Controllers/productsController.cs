...
namespace music_store.Controllers
{
    public class productsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "id,name,count,weigh,price,description,image,categories_id")] products products, HttpPostedFileBase upload)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "id,name,count,weigh,price,description,image,categories_id")] products products, HttpPostedFileBase upload)
        {
            try
            {
                if (ModelState.IsValid)
