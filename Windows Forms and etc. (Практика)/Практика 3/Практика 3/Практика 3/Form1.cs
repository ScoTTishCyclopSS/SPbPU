...
namespace Практика_3
{
    public partial class Form1 : Form
    {
        ...
        private void panel4_MouseMove(object sender, MouseEventArgs e)
        {
            ...
            label13.Text = "X: " + e.X.ToString() + " Y: " + e.Y.ToString();
        }
        ...
        {
            label14.Text = label14.Text + "Получение фокуса*";
        }

        private void textBox5_Enter(object sender, EventArgs e)
        {
            label14.Text = label14.Text + "Потеря фокуса*";
        }

        private void textBox4_Click(object sender, EventArgs e)
        {
            label14.Text = label14.Text + "Щелчок*";
        }

        private void textBox4_DoubleClick(object sender, EventArgs e)
        {
            label14.Text = label14.Text + "Двойной щелчок*";
        }

        private void textBox4_TextChanged(object sender, EventArgs e)
        {
            label14.Text = label14.Text + "Изменение в поле*";
        }
        ...
        private void label23_MouseMove_1(object sender, MouseEventArgs e)
        {
            ...
            label25.Text = "3.10 Мышь в 3 квадранте";
        }
        ...
        private void label24_MouseMove_1(object sender, MouseEventArgs e)
        {
            ...
            label25.Text = "3.10 Мышь в 4 квадранте";
        }
        ...
        {
            if (e.KeyCode == System.Windows.Forms.Keys.Left && pictureBox1.Left > 4)
            {
                pictureBox1.Left -= 5;
            }
            if (e.KeyCode == System.Windows.Forms.Keys.Right && pictureBox1.Left <= 214)
            {
                pictureBox1.Left += 5;
            }
            if (e.KeyCode == System.Windows.Forms.Keys.Up && pictureBox1.Top > 4)
            {
                pictureBox1.Top -= 5;
            }
            if (e.KeyCode == System.Windows.Forms.Keys.Down && pictureBox1.Top <= 177)
            {
                pictureBox1.Top += 5;
            }
